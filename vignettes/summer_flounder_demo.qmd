...
<img src="https://www.fisheries.noaa.gov/s3//2022-09/640x427-Flounder-Summer-NOAAFisheries.png?itok=wtEaG1bU" style="float:left; width:150px;"/>
...
```{r}
#| label: trawl map
knitr::include_graphics(here::here("images/summer flounder/summer flounder case study.png"))
```
...
```{r}
#| label: trawl lat map
knitr::include_graphics(here::here("images/summer flounder/summer flounder latitude map.png"))
```
