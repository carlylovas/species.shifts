...
```{r}
#| label: vtr
knitr::include_graphics("images/summer flounder vtr.png")
```
...
```{r}
#| label: obs
knitr::include_graphics("images/summer flounder observer map.png")
```
...
knitr::include_graphics("images/summer flounder landings.png")
```
...
#| out-width: 700px
#| out-height: 400px
knitr::include_graphics("images/summer flounder state landings.png")
```
...
#| out-width: 700px
#| out-height: 400px
knitr::include_graphics("images/summer flounder council landings.png")
```
...
#| out-width: 700px
#| out-height: 400px
knitr::include_graphics("images/summer flounder permits.png")
```
...
#| out-width: 700px
#| out-height: 400px
knitr::include_graphics("images/summer flounder permits by council.png")
```
...
#| out-width: 700px
#| out-height: 400px
knitr::include_graphics("images/summer flounder permit percentiles.png")
```
...
```{r}
#| label: permit maps
knitr::include_graphics("images/summer flounder permit map.png")
```
...
knitr::include_graphics("images/summer flounder catch.png")
```
...
knitr::include_graphics("images/summer flounder directed trips.png")
```
------------------------------------------------------------------------------------
