...
```
## About
Upon running the respective [`pull_()`](https://carlylovas.github.io/species.shifts/articles/data_cleaning_functions.html) functions, subsequent `plot_()` and `map_()` functions will allow users to visualize the data for species featured in `species_list()`. It is *strongly* advised to save the outputs from the `pull_()` functions locally, as some of the data pulling functions take quite a while to run. Saving locally will ensure that plotting, and any minor aesthetic revisions are done quickly and efficiently.

Below are examples of plots and maps that can be generated for each federal data set. All functions are written within [tidyverse](https://tidyverse.org/) and can be edited with a intermediate understanding of R.
...
```{r}
#| label: vtr
knitr::include_graphics(here::here("images/summer flounder/summer flounder vtr.png"))
```
...
```{r}
#| label: obs
knitr::include_graphics(here::here("images/summer flounder/summer flounder observer map.png"))
```
...
knitr::include_graphics(here::here("images/summer flounder/summer flounder landings.png"))
```
...
#| fig-align: center
knitr::include_graphics(here::here("images/summer flounder/summer flounder state landings.png"))
```
...
#| out-width: 700px
#| out-height: 400px
knitr::include_graphics(here::here("images/summer flounder/summer flounder council landings.png"))
```
...
#| out-width: 700px
#| out-height: 400px
knitr::include_graphics(here::here("images/summer flounder/summer flounder permits.png"))
```
...
#| out-width: 700px
#| out-height: 400px
knitr::include_graphics(here::here("images/summer flounder/summer flounder permits by council.png"))
```
...
#| out-width: 700px
#| out-height: 400px
knitr::include_graphics(here::here("images/summer flounder/summer flounder permit percentiles.png"))
```
...
```{r}
#| label: permit maps
knitr::include_graphics(here::here("images/summer flounder/summer flounder permit map.png"))
```
...
```{r}
#| label: trawl map
knitr::include_graphics(here::here("images/summer flounder/summer flounder cob map.png"))
```
```r
...
```{r}
#| label: trawl lat mao
knitr::include_graphics(here::here("images/summer flounder/summer flounder lat dist.png"))
```
```r
...
#| out-width: 700px
#| out-height: 400px
knitr::include_graphics(here::here("images/summer flounder/summer flounder centers.png"))
```
```r
...
knitr::include_graphics(here::here("images/summer flounder/summer flounder catch.png"))
```
...
knitr::include_graphics(here::here("images/summer flounder/summer flounder directed trips.png"))
```
------------------------------------------------------------------------------------
